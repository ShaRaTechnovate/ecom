...
// function FieldOptionEdit({ open, handleEdit, editData, additionalData }) {
...
//                             Edit Field Option
//                         </h4>
//                         <X style={{ color: 'white' }} className="fw-normal mt-25" size={25} onClick={handleEdit} />
//                     </div>
...
//                                     {/* <h6 className="mt-1">{prifileFileName}</h6> */}
//                                     {image && (
//                                         <img
//                                             alt="preview image"
//                                             src={image}
...
//                                         />
//                                     )}
//                                     <div className="cursor-pointer image-close">
//                                         <X />
//                                     </div>
//                                 </div>
//                             )}
...
// export default FieldOptionEdit;